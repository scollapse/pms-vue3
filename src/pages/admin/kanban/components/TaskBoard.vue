        ...
        <div class="space-y-4">
          <div v-for="task in paginatedTasks" :key="task.id"
            ...
            <div class="flex flex-col items-end space-y-2">
                 <span class="text-sm text-gray-500">{{ new Date(task.endTime).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' }) }}</span>
          ...
          <div class="flex justify-center space-x-4 mt-6">
            ...
            <span class="flex items-center text-sm text-gray-600">{{ totalPages === 0 ? '0 / 0' : `${currentPage} / ${totalPages}` }}</span>
